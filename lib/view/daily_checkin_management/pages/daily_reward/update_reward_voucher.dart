...
class UpdateRewardVoucher extends StatefulWidget {
  final String? idDoc;
  final String? image;
  ...
  @override
  State<UpdateRewardVoucher> createState() => _UpdateRewardVoucherState();
}

class _UpdateRewardVoucherState extends State<UpdateRewardVoucher> {
  Stream? menu;
                                                ...
                                                try {
                                                  ...
                                                  HistoryLogModel history =
                                                    ...
                                                    dateTime: DateFormat(
                                                        ...
                                                        .format(dateTime),
                                                    keterangan:
                                                        "Menambahkan reward daily voucher",
                                                    user: FirebaseAuth
                                                            .instance
                                                            .currentUser!
                                                            .email ??
                                                  ...
                                                  CustomToast.successToast(
                                                      context,
                                                      'Reward daily voucher berhasil dibuat!');
                                                } catch (error) {
                                                  setState(() {
                                                    _uploading = false;
                                                  });
