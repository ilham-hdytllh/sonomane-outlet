...
class UpdateTable extends StatefulWidget {
  ...
  final String maximumCapacity; //harusnya num tapi jgn diubah dulu takut error
  final String status;
...
class _UpdateTableState extends State<UpdateTable> {
  ...
  final List<String> _locationTable = [
    'A',
    'B',
  ];

  String _selectedtipemeja = 'A';
  final _tableNumber = TextEditingController();
  final _capacityMaks = TextEditingController();

  @override
  void initState() {
    super.initState();
    _tableNumber.text = widget.tableNumber.replaceAll(widget.tableLocation, "");
    _capacityMaks.text = widget.maximumCapacity;
    _selectedtipemeja = widget.tableLocation;
  }
                              ...
                              Flex(
                                ...
                                children: [
                                  ...
                                  CustomDropdown(
                                    ...
                                    onChanged: (value) {
                                      setState(() {
                                        _selectedtipemeja = value!;
                                      });
                                    },
                                    textNow: _selectedtipemeja,
                                  ),
                                  CustomFormField(
                                    readOnly: false,
                                    title: 'Capacity Max',
                                    textEditingController: _capacityMaks,
                                    hintText: "Capacity Max...",
                                    textInputType: TextInputType.number,
                                  ),
                                ],
                              ),
                                                ...
                                                try {
                                                  ...
                                                  TableModel table = TableModel(
                                                      ...
                                                      tableLocation:
                                                          _selectedtipemeja,
                                                      tableNumber:
                                                          "$_selectedtipemeja${_tableNumber.text}");
                                                  ...
                                                  await tableModel.addTable(
                                                      table,
                                                      "$_selectedtipemeja${_tableNumber.text}");
                                                  await tableModel.deleteTable(
                                                      widget.tableNumber);
