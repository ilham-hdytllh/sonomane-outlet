...
import 'package:sonomaneoutlet/view/inventory_management/pages/unit/update_unit.dart';

// ignore: must_be_immutable
class UnitTable extends StatefulWidget {
  List data;
  UnitTable({super.key, required this.data});
  ...
  DataRow getRow(int index) {
    return DataRow.byIndex(
      ...
      cells: [
        ...
        DataCell(Text(
          data[index]['unitName'].toString().capitalize(),
          style: Theme.of(context)
              .textTheme
              .titleMedium!
              .copyWith(fontSize: 14.sp),
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    delete() async {
                      try {
                        await deleteAdd.deleteUnit();
                        await historyLogFunction.addHistory(
                            history, idDocHistory);
                        // ignore: use_build_context_synchronously
                        CustomToast.successToast(
                            context, "Berhasil  menghapus unit");
                      } on FirebaseException catch (_) {
                        // ignore: use_build_context_synchronously
                        CustomToast.errorToast(
                            context, "Gagal  menghapus unit");
                      }
                    }
