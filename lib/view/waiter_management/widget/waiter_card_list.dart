              ...
              child: StreamBuilder(
                  ...
                  builder: (context, AsyncSnapshot snapshot) {
                    ...
                    snapshot.data.docs.map((value) {
                      ...
                      doc['idDoc'] = value.id;
                      data.add(doc);
                      if (value.data()['doneWaiter'] == true) {
                        dataDoneWaiter.add(value.data()['doneWaiter'] == true);
                      }
                    }).toList();
                          ...
                          onPressed: () async {
                            ...
                            for (int index = 0;
                              ...
                              await FirebaseFirestore.instance
                                  ...
                                  .update({"doneWaiter": true}).then((value) {
                                FirebaseFirestore.instance
                                    ...
                                    .doc(widget.tableOrderId)
                                    .collection("pesanan")
                                    .where("doneWaiter", isEqualTo: true)
                                    .get()
                                    .then((value) {
                                  doneWaiterLength = value.docs.length;
                                });
                              });
                            }

                            if (doneWaiterLength == data.length) {
                              await FirebaseFirestore.instance
                                  .collection("tables")
                                  .doc(widget.tablenumber)
                                  .collection("orders")
