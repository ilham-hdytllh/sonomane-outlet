...
class AddGeneralVoucher extends StatefulWidget {
  const AddGeneralVoucher({
    super.key,
  });

  @override
  State<AddGeneralVoucher> createState() => _AddGeneralVoucherState();
}

class _AddGeneralVoucherState extends State<AddGeneralVoucher> {
  Stream? menu;
