...
class SummaryReportCategoryTable extends StatefulWidget {
  final List transaction;
  const SummaryReportCategoryTable({Key? key, required this.transaction})
      : super(key: key);

  @override
  State<SummaryReportCategoryTable> createState() =>
      _SummaryReportCategoryTableState();
}

class _SummaryReportCategoryTableState
    extends State<SummaryReportCategoryTable> {
  @override
