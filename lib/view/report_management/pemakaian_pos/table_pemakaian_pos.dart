...
class TablePemakaianPos extends StatefulWidget {
  final List data;
  const TablePemakaianPos({super.key, required this.data});

  @override
  State<TablePemakaianPos> createState() => _TablePemakaianPosState();
}

class _TablePemakaianPosState extends State<TablePemakaianPos> {
  @override
