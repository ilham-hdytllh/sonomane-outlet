...
class AddSubscriptionVoucher extends StatefulWidget {
  const AddSubscriptionVoucher({
    super.key,
  });

  @override
  State<AddSubscriptionVoucher> createState() => _AddSubscriptionVoucherState();
}

class _AddSubscriptionVoucherState extends State<AddSubscriptionVoucher> {
  Stream? menu;
                                                ...
                                                try {
                                                  ...
                                                  HistoryLogModel history =
                                                    ...
                                                    dateTime: DateFormat(
                                                        ...
                                                        .format(dateTime),
                                                    keterangan:
                                                        "Menambahkan voucher subscription",
                                                    user: FirebaseAuth
                                                            .instance
                                                            .currentUser!
                                                            .email ??
