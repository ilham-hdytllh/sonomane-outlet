...
class SummaryReportPromoTable extends StatefulWidget {
  final List transaction;
  const SummaryReportPromoTable({Key? key, required this.transaction})
      : super(key: key);

  @override
  State<SummaryReportPromoTable> createState() =>
      _SummaryReportPromoTableState();
}

class _SummaryReportPromoTableState extends State<SummaryReportPromoTable> {
  @override
    ...
    for (var transaction in widget.transaction) {
      ...
      if (transactionStatus == 'sukses') {
        ...
        for (var item in items) {
          ...
          final salesData = categoryData[promoORno()]!;
