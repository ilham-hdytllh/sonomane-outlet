...
class PrintPaperPreviewNotInvoice extends StatefulWidget {
  ...
  const PrintPaperPreviewNotInvoice({
    super.key,
  ...
  @override
  State<PrintPaperPreviewNotInvoice> createState() =>
      _PrintPaperPreviewNotInvoiceState();
}

class _PrintPaperPreviewNotInvoiceState
    extends State<PrintPaperPreviewNotInvoice> {
  double sum = 0;
  double discount = 0;
              ...
              Column(
                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                CurrencyFormat.convertToIdr(widget.subTotal, 2),
                                style: GoogleFonts.robotoMono(
                                    color: SonomaneColor.scaffoldColorDark,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 14.sp),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Grand Total : ${CurrencyFormat.convertToIdr(widget.grandTotal, 2).toString()}",
                        style: GoogleFonts.robotoMono(
                            color: SonomaneColor.scaffoldColorDark,
                            fontWeight: FontWeight.w500,
                            fontSize: 18.sp),
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "Hanya untuk penagihan, bukan bukti bayar.",
                            style: GoogleFonts.robotoMono(
                                color: SonomaneColor.scaffoldColorDark,
                                fontWeight: FontWeight.w500,
                                fontSize: 14.sp),
