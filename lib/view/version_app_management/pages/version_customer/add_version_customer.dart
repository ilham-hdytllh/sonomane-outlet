...
class AddVersionCustomer extends StatefulWidget {
  const AddVersionCustomer({super.key});

  @override
  State<AddVersionCustomer> createState() => _AddVersionCustomerState();
}

class _AddVersionCustomerState extends State<AddVersionCustomer> {
  // formkey
