...
class UpdateSubCategory extends StatefulWidget {
  ...
  const UpdateSubCategory(
      {super.key, required this.idDoc, required this.subCategoryName});
...
class _UpdateSubCategoryState extends State<UpdateSubCategory> {
  ...
  void initState() {
    super.initState();
    _subCategoryName.text = widget.subCategoryName;
  }
