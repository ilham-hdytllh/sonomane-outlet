...
class TableStockOUT extends StatefulWidget {
  final List data;
  const TableStockOUT({super.key, required this.data});

  @override
  State<TableStockOUT> createState() => _TableStockOUTState();
}

class _TableStockOUTState extends State<TableStockOUT> {
  @override
