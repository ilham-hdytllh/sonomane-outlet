...
class TableVersionOutlet extends StatefulWidget {
  final List data;
  const TableVersionOutlet({super.key, required this.data});

  @override
  State<TableVersionOutlet> createState() => _TableVersionOutletState();
}

class _TableVersionOutletState extends State<TableVersionOutlet> {
            ...
            onTap: () {
              callback() async {
                await VersionFunction()
                    .deleteVersionOutlet(data[index]['idDoc']);
                ...
                HistoryLogModel history = HistoryLogModel(
                  ...
                  keterangan: "Menghapus versi app customer",
