...
class AddLoyaltyLevel extends StatefulWidget {
  const AddLoyaltyLevel({
    super.key,
  });

  @override
  State<AddLoyaltyLevel> createState() => _AddLoyaltyLevelState();
}

class _AddLoyaltyLevelState extends State<AddLoyaltyLevel> {
                                              ...
                                              if (_uploading == false) {
                                                ...
                                                try {
                                                  ...
                                                  CustomToast.successToast(
                                                      context,
                                                      'Level loyalty berhasil ditambahkan');
                                                } catch (error) {
                                                  setState(() {
                                                    _uploading = false;
                                                  });
                                                  ...
                                                  CustomToast.errorToast(
                                                      context,
                                                      'Level loyalty gagal ditambahkan');
                                                }
                                              }
                                            }
                                          },
