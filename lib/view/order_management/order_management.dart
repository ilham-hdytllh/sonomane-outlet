...
import 'package:sonomaneoutlet/view/order_management/pages/failed_order/order_failed.dart';
import 'package:sonomaneoutlet/view/order_management/pages/order_pending/order_pending.dart';
import 'package:sonomaneoutlet/view/order_management/pages/order_sukses/order_sukses.dart';
import 'package:sonomaneoutlet/view/order_management/widget/card_order.dart';
import 'package:sonomaneoutlet/shared_widget/search.dart';
import 'package:sonomaneoutlet/view/order_management/widget/report_sales_today.dart';
import 'package:sonomaneoutlet/view/order_management/widget/table_order.dart';

class ScreenOrderManagement extends StatefulWidget {
  const ScreenOrderManagement({super.key});

  @override
  State<ScreenOrderManagement> createState() => _ScreenOrderManagementState();
}

class _ScreenOrderManagementState extends State<ScreenOrderManagement> {
  final TextEditingController _search = TextEditingController();
  final TextEditingController _startDateTime = TextEditingController();
  final TextEditingController _endDate = TextEditingController();

  Stream? getTransaction;
  Stream? getTransactionGagal;
  Stream? getTransactionSukses;
  Stream? getTransactionPending;
  String? userName;
  ...
  void initState() {
    super.initState();
    getTransaction = TransactionFunction().getTransaction();
    getTransactionGagal = TransactionFunction().getTransactionFilter("gagal");
    getTransactionSukses = TransactionFunction().getTransactionFilter("sukses");
    getTransactionPending =
        TransactionFunction().getTransactionFilter("pending");
                              ...
                              children: [
                                StreamBuilder(
                                    ...
                                    builder: (context, snapshot) {
                                      if (snapshot.hasError) {
                                        return CardOrder(
                                          assetImage: 'assets/svg/check.png',
                                          type: 'Sukses',
                                          total: 0,
                                          onTap: () {},
                                          color: Colors.green,
                                ...
                                StreamBuilder(
                                    ...
                                    builder: (context, snapshot) {
                                      if (snapshot.hasError) {
                                        return CardOrder(
                                          assetImage: 'assets/svg/pending.png',
                                          type: 'Pending',
                                          total: 0,
                                          onTap: () {},
                                          color: Colors.amber,
