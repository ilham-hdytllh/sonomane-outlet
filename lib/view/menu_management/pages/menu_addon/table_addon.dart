...
import 'package:sonomaneoutlet/view/menu_management/pages/menu_addon/update_addon.dart';

class TableAddon extends StatefulWidget {
  final List data;
  const TableAddon({super.key, required this.data});

  @override
  State<TableAddon> createState() => _TableAddonState();
}

class _TableAddonState extends State<TableAddon> {
          ...
          Row(
            children: [
              GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    (MaterialPageRoute(
                      builder: (context) => UpdateAddon(
                          idDoc: data[index]['idDoc'],
                          addonName: data[index]['name'],
              ...
              GestureDetector(
                onTap: () {
                  callback() async {
                    await AddonFunction().deleteAddon(data[index]['idDoc']);
                    ...
                    HistoryLogModel history = HistoryLogModel(
                      ...
                      keterangan: "Menghapus menu addon",
