...
class UpdateLoyaltyVoucher extends StatefulWidget {
  final String? idDoc;
  final String? image;
  ...
  @override
  State<UpdateLoyaltyVoucher> createState() => _UpdateLoyaltyVoucherState();
}

class _UpdateLoyaltyVoucherState extends State<UpdateLoyaltyVoucher> {
  Stream? menu;
  ...
  void addToController() {
    _limitPerDay.text = widget.limitPerDay.toString();
    _membership = widget.level!;
