...
import 'package:sonomaneoutlet/view/voucher_management/pages/loyalty_voucher/update_loyalty_voucher.dart';

class TableLoyaltyVoucher extends StatefulWidget {
  final List data;
  const TableLoyaltyVoucher({super.key, required this.data});

  @override
  State<TableLoyaltyVoucher> createState() => _TableLoyaltyVoucherState();
}

class _TableLoyaltyVoucherState extends State<TableLoyaltyVoucher> {
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => UpdateLoyaltyVoucher(
                        idDoc: data[index]['idDoc'],
                        image: data[index]['image'],
                        discountPercent: data[index]['discountPercent'],
                        limitPerDay: data[index]['limitPerDay'],
                ...
                onTap: () {
                  callback() async {
                    ...
                    HistoryLogModel history = HistoryLogModel(
                      ...
                      keterangan: "Menghapus voucher loyalty",
