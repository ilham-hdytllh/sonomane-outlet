...
class UpdateBOM extends StatefulWidget {
  ...
  const UpdateBOM(
      ...
      required this.place,
      required this.itemsBOM});

  @override
  State<UpdateBOM> createState() => _UpdateBOMState();
}

class _UpdateBOMState extends State<UpdateBOM> {
  ...
  void addToController() {
    _placeDropdown = widget.place;
    _idMenu = widget.menuID;
    _codeBOM.text = widget.codeBOM;
    _menuName.text = widget.menuName;
    _allItemBOM.addAll(widget.itemsBOM);
  }
                              ...
                              Flex(
                                ...
                                children: [
                                  ...
                                  CustomFormField(
                                    readOnly: true,
                                    title: "Menu Name",
                                    textEditingController: _menuName,
                                    hintText: "Menu Name",
                                    textInputType: TextInputType.text,
                                  ),
                                  CustomDropdown(
                                    textNow: _placeDropdown,
                                    onChanged: (value) {
