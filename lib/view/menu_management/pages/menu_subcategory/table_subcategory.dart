...
import 'package:sonomaneoutlet/view/menu_management/pages/menu_subcategory/update_subcategory.dart';

class TableSubCategory extends StatefulWidget {
  final List data;
  const TableSubCategory({super.key, required this.data});

  @override
  State<TableSubCategory> createState() => _TableSubCategoryState();
}

class _TableSubCategoryState extends State<TableSubCategory> {
                ...
                onTap: () {
                  callback() async {
                    await SubCategoryFunction()
                        .deleteSubCategory(data[index]['idDoc']);
                    ...
                    HistoryLogModel history = HistoryLogModel(
                      ...
                      keterangan: "Menghapus subcategory",
                  ...
                  Notifikasi.warningAlertWithCallback(
                    context,
                    "Yakin ingin menghapus subcategory ini ?",
                    callback,
                  );
                },
                child: Container(
